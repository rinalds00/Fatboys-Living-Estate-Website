...
const SHARED_CSS = `
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}
  ...
  @media(max-width:768px){
    ...
    .page-hero{padding:6rem 1.25rem 3rem;min-height:50vh}
    .page-hero-content{padding:0}
    .page-title{font-size:clamp(1.9rem,8vw,3rem)}
    .page-tagline{font-size:.88rem}
    .intro-section{padding:3rem 1.25rem}
    .intro-layout{grid-template-columns:1fr;gap:2rem}
    .intro-heading{font-size:clamp(1.6rem,7vw,2.4rem)}
    .intro-text{font-size:.92rem;line-height:1.8}
    .intro-stats{flex-wrap:wrap;gap:1.5rem}
    .benefits-section{padding:3rem 1.25rem}
    .benefits-h2{font-size:clamp(1.6rem,7vw,2.4rem)}
    .benefits-grid{grid-template-columns:1fr;gap:0}
    .benefit-card{border-right:none;padding:1.75rem 0}
    .services-strip{padding:1.5rem 1.25rem}
    .services-strip-links{gap:.4rem}
    .other-services{padding:3rem 1.25rem}
    .other-services-grid{grid-template-columns:1fr 1fr;gap:1rem}
    .cta-strip{padding:2.5rem 1.25rem;flex-direction:column;gap:1.5rem;text-align:center}
    .cta-strip-title{font-size:clamp(1.4rem,6vw,2rem)}
    footer{padding:3rem 1.25rem 1.5rem}
    .footer-grid{grid-template-columns:1fr;gap:2rem;margin-bottom:2rem}
    .footer-bottom{flex-direction:column;gap:.75rem;text-align:center}
    .footer-bottom > div{flex-wrap:wrap;justify-content:center;gap:.75rem}
    .btn-forest{min-height:48px;display:inline-flex;align-items:center;justify-content:center;cursor:pointer}
...
<head>
  ...
  @media(max-width:768px){
    ...
    .page-title{font-size:clamp(1.9rem,8vw,3rem)}
    .page-tagline{font-size:.88rem}
    .intro-section{padding:2.5rem 1.25rem}
    .intro-layout{grid-template-columns:1fr!important;gap:2rem}
    .intro-heading{font-size:clamp(1.6rem,7vw,2.4rem)}
    .intro-text{font-size:.95rem;line-height:1.8}
    .intro-stats{flex-wrap:wrap;gap:1.5rem}
    .benefits-section{padding:2.5rem 1.25rem}
    .benefits-h2{font-size:clamp(1.6rem,7vw,2.4rem)}
    .benefits-grid{grid-template-columns:1fr!important;gap:0}
    .benefit-card{border-right:none;padding:1.75rem 0}
    .services-strip{padding:1.5rem 1.25rem}
    .cta-strip{padding:2.5rem 1.25rem;flex-direction:column;gap:1.5rem;text-align:center}
    .cta-strip-title{font-size:clamp(1.4rem,6vw,2rem);max-width:100%}
  }
  @media(max-width:480px){
    .intro-stats{gap:1.25rem}
  }
  ...
  <section class="intro-section">
    <div class="intro-layout reveal">
      ...
      <div>
        ...
        <div class="intro-stats" style="margin-top:2rem;padding-top:2rem;border-top:1px solid rgba(30,38,24,.1);display:flex;gap:3rem">
